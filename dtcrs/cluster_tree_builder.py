...
class ClusterTreeBuilder(TreeBuilder):
    ...
    def construct_tree(
        ...
        def process_cluster(
            ...
            print("NODETEXT:",node_texts)
            print("SUMMARYTEXT:", summarized_text)
        ...
        for layer in range(self.num_layers):
            ...
            if query_nodes:
                query_node_list = get_node_list(query_nodes)
